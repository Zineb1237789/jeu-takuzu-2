...
/////////////////////////////////////////////////////////////
//                                                         //
//           Equilibrer les valeurs dans les lignes   :    //
//                                                         //
/////////////////////////////////////////////////////////////

public class DIMACSGenerator2Ln {
    private final int n;
    private final int numVariables;
    private final int numClauses;
    private final String fileName;

    public DIMACSGenerator2Ln(int n, String fileName) {
        this.n = n;
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Entrez le nombre des colonnes : ");
        int n = scanner.nextInt();
        System.out.print("Entrez le nom du fichier de sortie : ");
        String fileName = scanner.next();

        DIMACSGenerator2Ln generator = new DIMACSGenerator2Ln(n, fileName);
